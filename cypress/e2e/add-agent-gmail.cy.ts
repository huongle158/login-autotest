 ...
 * 2. Create the new Agent with Auto response - ON
...
describe('Create a new Agent', () => {
  ...
  it('Create the new Agent with Auto response - ON', () => {
  ...
  it('Create the new Agent with Auto response - OFF', () => {
    // Click the + Add Agent button
    cy.contains('a', '+ Add Agent').should('be.visible').click();
    //Fill full data on the fields
